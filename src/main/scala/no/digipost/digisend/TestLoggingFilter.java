...
public class TestLoggingFilter extends ClientFilter {

	private static final Logger LOGGER = Logger.getLogger(TestLoggingFilter.class.getName());
	 ...
	 */
	public TestLoggingFilter(Logger logger) {
	 ...
	 */
	public TestLoggingFilter(PrintStream loggingStream) {
